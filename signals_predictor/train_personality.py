...
parser.add_argument("--head_type", default="regression", help="head type, choose from [regression, classification]")
parser.add_argument("--criterion_type", default="mse", help="criterion for regression, choose from [mse, mae, crossentropy]")
